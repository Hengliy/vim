...
Plugin 'bling/vim-airline-themes' "Airline themes enabled
...
"set airline_theme
""""""""""""""""""""""""""""""""""""
let g:airline_theme='papercolor' "'molokai'
...
func SetTitle() 
    ...
    if &filetype == 'sh' 
        ...
        call setline(1, "/*************************************************************************") 
        call append(line("."),   "    > File Name: ".expand("%")) 
        call append(line(".")+1, "    > Author: Hengliy") 
		call append(line(".")+2, "    > ################### ")
        call append(line(".")+3, "    > Mail: ################### ") 
        call append(line(".")+4, "    > Created Time: ".strftime("%c")) 
        call append(line(".")+5, " ************************************************************************/") 
